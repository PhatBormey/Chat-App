...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
            ...
            <div className="form-control mb-5">
              {/* <div className="relative">
                <label className="label ">
                  <span className="label-text font-medium absolute inset-y-0 left-0 pl-0 flex items-center pointer-events-none mb-3">Full Name</span>
                </label>
              </div> */}
              <div className="relative">
      ...
      {/* Right Side */}
      <AuthImagePattern
        title="Join our conmunity"
        subtitle="Connect with friends, share moments and stays in touch withyour love ones."
      />
    </div>
  );
};
